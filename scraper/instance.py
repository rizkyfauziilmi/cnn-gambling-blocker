...
class Scraper:
    def __init__(self, log_level: int = INFO) -> None:
        ...
        self.mobile_context = self.browser.new_context(**self.playwright.devices["iPhone 13"])
        self.desktop_context = self.browser.new_context(viewport={"width": 1280, "height": 720})
